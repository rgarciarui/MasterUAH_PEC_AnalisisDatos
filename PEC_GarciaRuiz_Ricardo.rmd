...
4. Realizamos la limpieza de la neva variable **Title** ajustando los titulos que nos son correctos con los aceptados y, finalmente, el resto de datos no ajustables se sustituyen por la palabra 'Otros'.
